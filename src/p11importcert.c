...
void print_usage(char *progname)
{
    fprintf( stderr,
	     ...
	     "* -f <file> : path to a valid PEM or DER formatted X.509 Certificate\n"
	     "* -i <cert_alias>: label/alias to give to certificate\n"
	     "  -T : set CKA_TRUST=true on certificate (may require -S)\n"
