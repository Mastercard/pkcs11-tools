...
void print_usage(char *progname)
{
    fprintf( stderr, 
	     ...
	     " NSE : key is not sensitive (clear text value could leave token boundary)\n"
	     ...
	     " dcp : supports decapsulation (KEM private key)\n"
	     " dct : decapsulate template present\n"
