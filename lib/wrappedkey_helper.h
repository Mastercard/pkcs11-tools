...
func_rc _wrappedkey_parser_append_cryptogram(wrappedKeyCtx *ctx, unsigned char *b64buffer, int keyindex);
func_rc _wrappedkey_parser_set_wrapping_key(wrappedKeyCtx *ctx, void *buffer, size_t len);
func_rc _wrappedkey_parser_set_wrapping_alg(wrappedKeyCtx *ctx, enum wrappingmethod meth, int keyindex );
